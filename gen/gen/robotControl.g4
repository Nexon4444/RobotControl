...
ifStment
: (IF LNBRACKET expr RNBRACKET LCBRACKET script RCBRACKET)
| (IF LNBRACKET expr RNBRACKET LCBRACKET script RCBRACKET ELSE LCBRACKET script RCBRACKET)
;
...
whileStment
: WHILE LNBRACKET expr RNBRACKET LCBRACKET script RCBRACKET
;
